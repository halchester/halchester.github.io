                        ...
                        success: function (data) {
                            ...
                            for (var i = 0; i < data.query.results.channel.item.forecast.length && i < days; i++) {
                                ...
                                if (i == 0) {
                                    ...
                                    high = "<p class='highTemp'> အပူချိန်: " + data.query.results.channel.item.forecast[i].high + " &deg;F</p>";
                                    low = "<p class='lowTemp'>  အပူချိန်: &nbsp;" + data.query.results.channel.item.forecast[i].low + " &deg;F</p>";
                                    ...
                                    mmday = data.query.results.channel.item.forecast[i].day;
                                    //wind = data.query.results.channel.item.forecast[i].wind;
                                 //alert(wind);
                                    /*if (mmday == "Mon") {
                                            mmday = "တနင်္လာ";
                                        }*/
                                        ...
                                        mmdec = data.query.results.channel.item.forecast[i].text
                                       /*alert(mmdec);*/
                                       switch(mmdec) {
                                            case "Sunny":
                                                mmdec = "နေသာသည်";
                                            break;
                                            case "Mostly Cloudy":
                                            mmdec = "နေရာအနံ့အပြား တိမ်ထူ";
                                            break;
                                            case "Cloudy":
                                            mmdec = "တိမ်ထူ";
                                            break;
                                            case "Partly Cloudy":
                                            mmdec = "တိမ်အသင့်အတင့်";
                                            break;
                                            case "Scattered Thunderstorms":
                                            mmdec = "မိုးကြိုးမုန်တိုင်း";
                                            break;
                                            case "Showers":
                                            mmdec = "နှင်းကျ";
                                            break;
